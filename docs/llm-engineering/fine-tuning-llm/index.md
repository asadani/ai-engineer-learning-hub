...
!!! warning "2026 Update — what changed since this was written (as of May 2026)"
    ...
    - Reinforcement learning with verifiable rewards (RLVR) — GRPO-style, popularized by **DeepSeek-R1** — is the dominant recipe for eliciting/distilling reasoning. The topic's GRPO coverage maps directly to this; frame it as reasoning fine-tuning + reasoning distillation into smaller models.

    **Sources:** [DeepSeek-R1 — incentivizing reasoning via RL (paper)](https://arxiv.org/abs/2501.12948) · [Hugging Face — TRL (GRPO, DPO, SFT)](https://huggingface.co/docs/trl/index)
...
!!! info "Official Sources & Further Reading"
    ...
    - [Hugging Face — Training & fine-tuning guide](https://huggingface.co/docs/transformers/training)
    - [Hugging Face — TRL (SFT, DPO, reward modeling)](https://huggingface.co/docs/trl/index)
