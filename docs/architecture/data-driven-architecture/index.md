...
!!! info "Official Sources & Further Reading"
    ...
    - [Zhamak Dehghani — How to move beyond a monolithic data lake](https://martinfowler.com/articles/data-monolith-to-mesh.html)
    - [dbt — Data contracts](https://docs.getdbt.com/docs/collaborate/govern/model-contracts)
    - [AWS — Analytics Lens (Well-Architected)](https://docs.aws.amazon.com/wellarchitected/latest/analytics-lens/analytics-lens.html)
